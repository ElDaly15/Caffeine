...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "caffeine_order":
            MessageLookupByLibrary.simpleMessage("كفايـــين اوردر"),
        ...
        "forgot_password_message": MessageLookupByLibrary.simpleMessage(
          "لا تقلق، فقط اكتب بريدك الإلكتروني وسنرسل لك رابطًا لإعادة تعيين كلمة المرور.",
        ),
        ...
        "welcome_message": MessageLookupByLibrary.simpleMessage(
          "مرحبًا بك في ركن القهوة الدافئ لدينا، حيث كل فنجان هو متعة لك.",
        ),
